...
import type {
  ISeacowsPairERC20,
  ISeacowsPairERC20Interface,
} from "../ISeacowsPairERC20";
...
export class ISeacowsPairERC20__factory {
  static readonly abi = _abi;
  static createInterface(): ISeacowsPairERC20Interface {
    return new utils.Interface(_abi) as ISeacowsPairERC20Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ISeacowsPairERC20 {
    return new Contract(address, _abi, signerOrProvider) as ISeacowsPairERC20;
  }
}
