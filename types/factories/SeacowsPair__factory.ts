...
import type { SeacowsPair, SeacowsPairInterface } from "../SeacowsPair";
...
export class SeacowsPair__factory {
  static readonly abi = _abi;
  static createInterface(): SeacowsPairInterface {
    return new utils.Interface(_abi) as SeacowsPairInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SeacowsPair {
    return new Contract(address, _abi, signerOrProvider) as SeacowsPair;
  }
}
