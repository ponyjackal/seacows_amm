...
export class SeacowsPairETH__factory {
  static readonly abi = _abi;
  static createInterface(): SeacowsPairETHInterface {
    return new utils.Interface(_abi) as SeacowsPairETHInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SeacowsPairETH {
    return new Contract(address, _abi, signerOrProvider) as SeacowsPairETH;
  }
}
