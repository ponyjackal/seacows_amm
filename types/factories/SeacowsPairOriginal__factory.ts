...
import type {
  SeacowsPairOriginal,
  SeacowsPairOriginalInterface,
} from "../SeacowsPairOriginal";
...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "enum SeacowsPairOriginal.PoolType",
        name: "_poolType",
        type: "uint8",
      },
    ],
...
export class SeacowsPairOriginal__factory {
  static readonly abi = _abi;
  static createInterface(): SeacowsPairOriginalInterface {
    return new utils.Interface(_abi) as SeacowsPairOriginalInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SeacowsPairOriginal {
    return new Contract(address, _abi, signerOrProvider) as SeacowsPairOriginal;
  }
}
