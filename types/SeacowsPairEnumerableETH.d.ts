...
interface SeacowsPairEnumerableETHInterface extends ethers.utils.Interface {
  functions: {
    ...
    "removeLPETH(address,uint256)": FunctionFragment;
...
export class SeacowsPairEnumerableETH extends BaseContract {
  ...
  interface: SeacowsPairEnumerableETHInterface;
