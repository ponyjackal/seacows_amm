...
interface SeacowsPairERC20Interface extends ethers.utils.Interface {
  functions: {
...
export class SeacowsPairERC20 extends BaseContract {
  ...
  interface: SeacowsPairERC20Interface;
