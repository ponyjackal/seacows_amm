...
interface SeacowsPairEnumerableInterface extends ethers.utils.Interface {
  functions: {
...
export class SeacowsPairEnumerable extends BaseContract {
  ...
  interface: SeacowsPairEnumerableInterface;
