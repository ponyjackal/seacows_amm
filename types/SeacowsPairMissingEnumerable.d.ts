...
interface SeacowsPairMissingEnumerableInterface extends ethers.utils.Interface {
  functions: {
...
export class SeacowsPairMissingEnumerable extends BaseContract {
  ...
  interface: SeacowsPairMissingEnumerableInterface;
