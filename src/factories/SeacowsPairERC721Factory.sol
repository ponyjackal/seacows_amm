...
contract SeacowsPairERC721Factory is Ownable, ISeacowsPairFactoryLike {
    ...
    constructor(address _weth, SeacowsPairERC721 _erc721Template, address payable _protocolFeeRecipient, uint256 _protocolFeeMultiplier) {
        weth = _weth;
