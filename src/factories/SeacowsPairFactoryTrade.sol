...
//         SeacowsPairTrade.PoolType poolType;
//         uint128 delta;
//         uint96 fee;
//         uint128 spotPrice;
...
//         SeacowsPairTrade.PoolType _poolType,
//         uint128 _delta,
//         uint96 _fee,
//         uint128 _spotPrice,
//         uint256[] calldata _initialNFTIDs
//     ) external payable returns (SeacowsPairTrade pair) {
...
//         SeacowsPairTrade.PairInitializeParams memory initParams = SeacowsPairTrade.PairInitializeParams(
//             this,
//             _bondingCurve,
//             address(_nft),
//             _poolType,
...
//         @return pair The new pair
//      */
//     function createPairERC1155ETH(CreateERC1155ETHPairParams calldata params) external payable returns (SeacowsPairTrade) {
//         IWETH(weth).deposit{ value: msg.value }();
//         (SeacowsPairTrade pair, uint256 totalAmount) = _createPairERC1155ERC20(params.nft, params.poolType, params.nftIds, params.nftAmounts);

//         uint128 spotPrice = params.spotPrice;
//         if (params.poolType == SeacowsPairTrade.PoolType.TRADE) {
...
//         @return pair The new pair
//      */
//     function createPairERC20(CreateERC721ERC20PairParams calldata params) external returns (SeacowsPairTrade pair) {
...
//         @return pair The new pair
//      */
//     function createPairERC1155ERC20(CreateERC1155ERC20PairParams calldata params) external payable returns (SeacowsPairTrade) {
//         (SeacowsPairTrade pair, uint256 totalAmount) = _createPairERC1155ERC20(params.nft, params.poolType, params.nftIds, params.nftAmounts);
...
//      */
//     function disableProtocolFee(SeacowsPairTrade _pair, bool _isProtocolFeeDisabled) external onlyOwner {
...
//      * Internal functions
//      */
//     function _createPairERC721ERC20(CreateERC721ERC20PairParams memory params) internal returns (SeacowsPairTrade pair) {
//         require(
//             params.poolType != SeacowsPairTrade.PoolType.TOKEN || params.initialTokenBalance > params.spotPrice,
//             "Insufficient initial token amount"
//         );

//         address template = address(erc721Template);

//         pair = SeacowsPairTrade(payable(template.clone()));
...
//     function _createPairERC1155ERC20(IERC1155 nft, SeacowsPairTrade.PoolType poolType, uint256[] memory nftIds, uint256[] memory nftAmounts)
//         internal
//         returns (SeacowsPairTrade pair, uint256 totalAmount)
//     {
...
//         // mint LP tokens if trade pair
//         if (poolType == SeacowsPairTrade.PoolType.TRADE) {
//             // mint LP tokens
//             uint256 id = _createNewPositionToken(address(pair));
...
//      */
//     function addLiquidityERC721ERC20(SeacowsPairTrade _pair, uint256[] calldata _nftIDs, uint256 _amount) public {
//         uint256 numNFTs = _nftIDs.length;

//         require(_pair.poolType() == SeacowsPairTrade.PoolType.TRADE, "Not a trade pair");
//         require(numNFTs > 0, "Invalid NFT amount");
//         require(numNFTs * _pair.spotPrice() <= _amount, "Insufficient token amount");

//         // transfer tokens to pair
//         _pair.token().transferFrom(msg.sender, address(_pair), _amount);
...
//      * @param _nftIDs NFT ids
//      */
//     function addLiquidityERC721ETH(SeacowsPairTrade _pair, uint256[] calldata _nftIDs) external payable {
//         uint256 numNFTs = _nftIDs.length;
...
//      */
//     function removeLiquidityERC721ERC20(SeacowsPairTrade _pair, uint256 _amount, uint256[] calldata _nftIDs, bool _toEth) public {
//         uint256 numNFTs = _nftIDs.length;
...
//             _pair.token().transferFrom(address(_pair), address(this), tokenAmount);
//             IWETH(weth).withdraw(tokenAmount);
//             payable(msg.sender).transfer(tokenAmount);
//         } else {
//             _pair.token().transferFrom(address(_pair), msg.sender, tokenAmount);
//         }
...
//      * @param _nftIDs NFT ids to withdraw
//      */
//     function removeLiquidityERC721ETH(SeacowsPairTrade _pair, uint256 _amount, uint256[] calldata _nftIDs) external {
