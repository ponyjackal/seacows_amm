...
contract WhenBuyNFTs is WhenCreatePair {
    ...
    function testBuyNFTsWithProtocolFee() public {
        ...
        ISeacowsPairERC721(address(erc721ETHPair)).swapTokenForSpecificNFTs(nftIds, 15 ether, address(alice), false);
        /** Check nft owners */
    ...
    function testBuyNFTsWithOutProtocolFee() public {
        ...
        ISeacowsPairERC721(address(erc721ERC20Pair)).swapTokenForSpecificNFTs(nftIds, 15 ether, address(alice), false);
        /** Check nft owners */
    ...
    function testBuyWithInsufficientTokens() public {
        ...
        vm.expectRevert();
        ISeacowsPairERC721(address(erc721ETHPair)).swapTokenForSpecificNFTs(nftETHIds, 15 ether, address(alice), false);
        ...
        ISeacowsPairERC721(address(erc721ERC20Pair)).swapTokenForSpecificNFTs(nftIds, 10 ether, address(alice), false);
