...
contract WhenBuyNFTs is WhenCreatePair {
    ...
    function testBuyNFTsWithProtocolFee() public {
        ...
        seacowsRouterV1.swapTokenForNFTsETHERC721{ value: 15 ether }(params, address(alice));
        /** Check nft owners */
    ...
    function testBuyWithInsufficientTokens() public {
        ...
        vm.expectRevert();
        seacowsRouterV1.swapTokenForNFTsETHERC721{ value: 10000005 ether }(ethParams, address(alice));
        ...
        seacowsRouterV1.swapTokenForNFTsERC721(params, 10 ether, address(alice));
