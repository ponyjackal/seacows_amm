...
contract TestDisableProtocolFee is WhenCreatePair {
    ...
    function testEnableTokenPairProtocolFee() public {
        ...
        ISeacowsPairERC721(address(tokenPair)).swapNFTsForToken(nftIds, 25 ether, payable(alice), false, address(0));
    ...
    function testEnableNFTPairProtocolFee() public {
        ...
        ISeacowsPairERC721(address(nftPair)).swapTokenForAnyNFTs(2, 25 ether, payable(alice), false, address(0));
        /** Check alice token balance */
        uint256 aliceTokenBalanceUpdated = token.balanceOf(alice);
    ...
    function testDisableNFTPairProtocolFee() public {
        ...
        ISeacowsPairERC721(address(nftPair)).swapTokenForSpecificNFTs(nftIds, 25 ether, payable(alice), false, address(0));
        /** Check alice token balance */
        uint256 aliceTokenBalanceUpdated = token.balanceOf(alice);
