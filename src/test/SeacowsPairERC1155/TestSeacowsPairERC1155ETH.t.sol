...
contract SeacowsPairERC1155ETHTest is WhenCreatePair {
    ...
    function setUp() public override(WhenCreatePair) {
        ...
        // create a pair
        vm.startPrank(owner);
        pair = createERC1155ETHPair(testSeacowsSFT, 1, 1000, 100000 ether, 10);
        vm.stopPrank();
    ...
    function test_add_liquidity() public {
        ...
        seacowsPairFactory.addLiquidityETHERC1155{ value: 10000 ether }(ISeacowsPairERC1155ERC20(address(pair)), 100);
        ...
        assertEq(tokenBalance, 110000 ether);
        ...
        seacowsPairFactory.addLiquidityETHERC1155{ value: 100 ether }(ISeacowsPairERC1155ERC20(address(pair)), 100);

        vm.expectRevert("Invalid NFT amount");
        seacowsPairFactory.addLiquidityETHERC1155{ value: 10000 ether }(ISeacowsPairERC1155ERC20(address(pair)), 0);
    ...
    function test_remove_liquidity() public {
        ...
        uint256 tokenBalance = IERC20(weth).balanceOf(address(pair));
        assertEq(tokenBalance, 109000 ether);
        // check pair erc1155 balance
        uint256 sftBalance = testSeacowsSFT.balanceOf(address(pair), 1);
